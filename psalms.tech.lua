-- fixed version by sh4k4r6o on discord
setfpscap(1000)
...
print("psalms.tech fixed by sh4k4r6o")
...
if game.PlaceId == 9825515356 then
    ...
    local Argumen = { -- fixed by sh4k4r6o on discord plz credit me
    "UpdateMousePos",
    "GetMousePos",
    "MousePos",
    "MOUSE",
...
for _, Value in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
    if table.find({"MainEvent", "Bullets", ".gg/untitledhood", "Remote", "MAINEVENT"}, Value.Name) then
        MainEvent = Value
        break
    end
end
